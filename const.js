...
export const FILTER_TEXT_INPUT = document.querySelector("#filterText");
...
export const FILTER_END_INPUT = document.querySelector("#filterEnd");
...
export const FILTER_BUTTON = document.querySelector("#filterButton")
